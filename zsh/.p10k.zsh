# Generated by Powerlevel10k configuration wizard on 2026-01-02 at 22:00 KST.
...
() {
  ...
  COLOR_BG='#1d3337'
  COLOR_FG='#eaeeee'
  COLOR_FG_DARK='#cbd9d8'

  # Default background color.
  typeset -g POWERLEVEL9K_BACKGROUND=$COLOR_BG

  # Default current directory color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$COLOR_FG_DARK

  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$COLOR_FG
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$COLOR_FG

  # Default hostname color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=$COLOR_FG_DARK
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=$COLOR_FG
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=$COLOR_FG
